...
final class Colors {
    ...
    static final Color incomingLine   = new Color(255,0,0);
    static final Color outgoingLine   = new Color(0,0,255);
    static final Color unselectedLine = new Color(255,255,255);
